...
export const translations: Record<Language, Translations> = {
  ...
  bg: {
    ...
    // Product Types
    addProductType: 'Добави категория',
    editProductType: 'Редактирай категория',

  // Properties
  properties: 'Характеристики',
  addProperty: 'Добави характеристика',
  editProperty: 'Редактирай характеристика',
  confirmDeleteProperty: 'Сигурни ли сте, че искате да изтриете тази характеристика?',
  failedToSaveProperty: 'Неуспешно запазване на характеристика',
  failedToDeleteProperty: 'Неуспешно изтриване на характеристика',
  propertyValues: 'Стойности на характеристиките',
  addValue: 'Добави стойност',
  editValue: 'Редактирай стойност',
  deleteValue: 'Изтрий стойност',
  noValuesDefined: 'Няма дефинирани стойности. Кликнете "Добави стойност" за да създадете опции за тази характеристика.',
  addPropertyValue: 'Добави стойност на характеристика',
  editPropertyValue: 'Редактирай стойност на характеристика',
  confirmDeletePropertyValue: 'Сигурни ли сте, че искате да изтриете тази стойност на характеристика?',
  propertyValueDeletedLocally: 'Стойността на характеристика е изтрита локално. Необходима е миграция на базата данни за постоянство.',
  propertyValueSavedLocally: 'Стойността на характеристика е запазена локално. Необходима е миграция на базата данни за постоянство.',
  propertyValueSavedLocallyFull: 'Стойността на характеристика е запазена локално. Необходима е миграция на базата данни за пълна функционалност.',
  description: 'Описание',
  dataType: 'Тип данни',
  text: 'Текст',
  select: 'Избор',
  number: 'Число',
  propertyColon: 'Характеристика: ',
  ...
  noPropertiesFound: 'Няма намерени характеристики. Създайте едно, за да започнете.',
  ...
  // Product Management
  selectAtLeastOnePropertyValue: 'Моля изберете поне една стойност на характеристика',
  propertyTypeNotSupportVariants: 'Този тип характеристика не поддържа варианти. Добавете стойности в секцията Характеристики.',
  ...
  emailPendingAfterConfirm: 'След потвърждение ще получите информация за изпращане (работни дни: днес до 13:00 ч., иначе следващия работен ден; поръчки в събота/неделя — изпращане в понеделник).',
  ...
  // Properties
  previous: 'Предишна',
  failedToDeletePropertyValue: 'Неуспешно изтриване на стойност на характеристика',
  ...
  manageProperties: 'Управление на характеристиките',
